...
const styles = StyleSheet.create({
  ...
  newBtnText: { color: colors.accentInk, fontSize: 15, fontWeight: '700' },
  ...
  errorBannerText: { color: colors.expense, fontSize: 13, flex: 1 },
  ...
  locked: { color: colors.inkSoft, fontSize: 11, fontStyle: 'italic' },
  actions: { flexDirection: 'row', gap: spacing.md },
  actionText: { color: colors.accent, fontSize: 13, fontWeight: '600' },
  emptyText: { color: colors.inkSoft, fontSize: 13, paddingVertical: spacing.lg, textAlign: 'center' },
  ...
  undoText: { color: colors.surface, fontSize: 13, flex: 1 },
  undoBtn: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: spacing.xs,
